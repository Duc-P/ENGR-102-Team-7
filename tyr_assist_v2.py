...
num_case = 246 # how test case(s) would you like to generate (250 - 4 corners)
...
def M_cho_point(cho,age):
    ...
    #6 points
        ...
        return 6
    #7 points
    elif (20 <= age <= 39) and (200 <= cho <= 239): # FIXED
        return 7
    #8 points
    ...
    #11 points
        ...
        return 0
    # REVIEWED: 6:21 P.M. Fri Sep 3 (Duc Pham)
...
def F_cho_point(cho, age):
    ...
    #13 points
        ...
        return 0
    # REVIEWED: 6:37 P.M. Fri Sep 13 (Duc Pham)
...
def M_smo_point(smo, age):
    if smo == "N":
        ...
        return 0
    # REVIEWED: 6:40 P.M. Fri Sep 13 (Duc Pham)
...
def F_smo_point(smo, age):
    if smo == "N":
        ...
        return 0
    # REVIEWED: 6:43 P.M. Fri Sep 13 (Duc Pham)
...
def M_sbp_med_point(sbp,med):
    if med == "Y":
        ...
        if (sbp < 120):
            ...
            return 0
    # REVIEWED: 6:41 P.M. Fri Sep 13 (Duc Pham)
...
def F_sbp_med_point(sbp,med):
    if med == "Y":
        ...
        if (sbp < 120):
            ...
            return 0
    # REVIEWED: 6:39 P.M. Fri Sep 13 (Duc Pham)
...
def point_calc(pc_sex, pc_age, pc_cho, pc_smo, pc_hdl, pc_sbp, pc_med):
    ...
    if pc_sex == "M":
        ...
        return(points)
    #REVIEWED: 6:45 P.M. Fri Sep 13 (Duc Pham)
...
def out_calc (oc_point, sex): # input point and return expected output (%)
    if sex == "M":
        ...
        if oc_point < 9:
            ...
            return ">30"
        # REVIEWED: 6:24 Fri Sep 13 (Duc Pham)
